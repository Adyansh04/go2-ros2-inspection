"""3D occupancy map (OctoMap) for the Go2: a colored-voxel 3D occupancy map.
                ...
                parameters=[
                    {
                        ...
                        "resolution": 0.10,  # voxel size in meters
                        ...
                        "height_map": True,  # color voxels by height
                        "colored_map": False,
                        "latch": False,
                    }
                ],
                remappings=[
                    ("cloud_in", "/utlidar/cloud_filtered")
                ],  # self-filtered (no robot body) — ADR-013
            ),
        ]
    )
