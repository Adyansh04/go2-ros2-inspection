...
def generate_launch_description():
    ...
    fwd = {"world": world, "headless": headless,
           "actor": LaunchConfiguration("actor"), "fire": LaunchConfiguration("fire"),
           "spawn_x": LaunchConfiguration("spawn_x"), "spawn_y": LaunchConfiguration("spawn_y"),
    ...
    static_map_odom = Node(
        package="tf2_ros", executable="static_transform_publisher", name="static_map_odom", output="screen",
        arguments=["--frame-id", "map", "--child-frame-id", "odom"],   # identity (map == ground-truth odom)
    ...
    slam = IncludeLaunchDescription(
        ...
        launch_arguments={**fwd, "localization": "true", "grid_topic": "/rtabmap/grid_map"}.items(),
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument("static_map_odom", default_value="true"),   # sim: static identity map->odom
